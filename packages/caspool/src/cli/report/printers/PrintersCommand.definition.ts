...
export const PrintersCommandDefinition: ICommandDefinition = {
    name: "printers",
    aliases: ["prt"],
    summary: "List CA Spool Printers",
    description: "List CA Spool Printers",
    type: "command",
    handler: __dirname + "/PrintersCommand.handler",
    profile: {
        optional: ["zosmf", "tso"],
    },
    // positionals: [
    ...
    examples: [
        {
            description: 'Issue command "report printers" to get a list of all printers',
            options: "",
        }
    ],
};
