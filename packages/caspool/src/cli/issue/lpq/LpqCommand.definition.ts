...
export const LpqCommandDefinition: ICommandDefinition = {
    name: "lpq",
    aliases: [],
    summary: "Issue lpq to a CA Spool node",
    description: "Issue lpq to a CA Spool node",
    type: "command",
    handler: __dirname + "/LpqCommand.handler",
    profile: {
        optional: ["zosmf", "tso"],
    },
    positionals: [
